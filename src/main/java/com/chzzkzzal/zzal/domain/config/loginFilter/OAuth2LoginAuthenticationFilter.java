package com.chzzkzzal.zzal.domain.config.loginFilter;
...
public class OAuth2LoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	public OAuth2LoginAuthenticationFilter(ObjectMapper objectMapper,
	...
	public Authentication attemptAuthentication(
		...
		validateCorrectAuthContentType(request);
		...
		validateLoginDataIsNull(username, password);
	...
	private void validateLoginDataIsNull(String username, String password) {
		if (username == null || password == null) {
			throw new AuthenticationServiceException("DATA IS MISS");
		}
	}

	private void validateCorrectAuthContentType(HttpServletRequest request) {
